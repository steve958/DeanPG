    ...
    <div className="content-container">
      {!isVisible && (
        <div className="home-icon">
          <span onClick={handleTopArrowClick}>
            <CgArrowUpR color="white" size={100} className="arrow-top" />
          </span>
        </div>
      )}
      ...
      <div className="main-footer">
        <p>
          {language
            ? "Tražite pouzdanog partnera za izgradnju ili renoviranje?"
            : "Looking for a reliable partner for construction or renovation?"}
        </p>
      ...
      <div className="projects-section">
        <div className="projects-summary">
          ...
          <div className="middle-section">
            <span>
              <p>{language ? "Naše" : "Our"}</p>
              <p className="yellow-text">{language ? "usluge" : "services"}</p>
            </span>
            <p className="description">
              {language
                ? "Naša tvrtka je specijalizirana za izgradnju stambenih objekata. Tvrtka zapošljava tim kvalificiranih radnika, kao što su zidari, stolari, keramičari, električari, vodoinstalateri i drugi djelatnici, za izgradnju građevinskih projekata."
                : "Our company specializes in construction residential buildings. The company employs a team of qualified workers, such as masons, carpenters, ceramicists, electricians, plumbers and other workers, for building construction projects."}
            </p>
            <div className="images-section">
              ...
              >
                {renovationHover && (
                  <div className="renovation-display">
                    <p>
                      {language
              ...
              >
                {constructionHover && (
                  <div className="construction-display">
                    <p>
                      {language
                        ? "izgradnja objekata"
              ...
              >
                {housesHover && (
                  <div className="houses-display">
                    <p>
                      {language
                        ? "izgradnja montažnih kuća po sistemu ključ u ruke"
        ...
        {galleryCover && (
          <div className="covering-div" onClick={() => setGalleryCover(false)}>
            <p>
              {language
                ? "kliknite da vidite slike naših projekata"
                : "click to see images of our projects"}
            </p>
          </div>
        )}
        <Gallery />
        ...
        <div className="about-description">
          ...
          <div className="about-text">
            <span className="about-us">
              {language ? "O" : "ABOUT"}{" "}
              <p className="yellow-text">{language ? "NAMA" : "US"}</p>
            </span>
            <span>
      ...
      <div className="about-icons">
        <span>
          {" "}
          <MdOutlineHighQuality size={100} color="#454545" />{" "}
          <p>{language ? "VISOKA KVALITETA" : "HIGH QUALITY"}</p>
        </span>
        <span>
          {" "}
          <RiMoneyEuroBoxLine size={90} color="#454545" />{" "}
          <p>{language ? "UNUTAR PRORAČUNA" : "WITHIN THE BUDGET"}</p>
        </span>
        <span>
          {" "}
          <IoMdTimer size={90} color="#454545" />
          <p>{language ? "UVIJEK NA VRIJEME" : "WITHIN THE TIME LIMIT"}</p>
        </span>
      </div>
      <div className="contact-background"></div>
      <div className="contact-section">
        <span className="contact-text">
          <p>{language ? "KONTAKT" : "CONTACT"}</p>
        </span>
        <span className="contact-icons">
          <span>
            <BsTelephone size={30} color="gold" />
            +385 95 3466 323
          </span>
          <span>
            <MdOutlineAlternateEmail size={30} color="gold" />
        ...
        >
          ...
          <span className="contact-form">
            <span className="info-box">
              ...
              <input
                type="number"
                placeholder={language ? "broj telefona" : "telephone number"}
                name="user_number"
                required
              />
            </span>
            <span className="msg-box">
              <textarea
                name="message"
                id=""
                placeholder={language ? "vaša poruka" : "your message"}
                required
              ></textarea>
            </span>
          </span>
          <button className="send-msg" type="submit">
            {language ? "POŠALJITE PORUKU" : "SEND MESSAGE"}
          </button>
        </form>
